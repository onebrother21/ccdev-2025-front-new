...
declare type RespChartConfiguration = ChartConfiguration & {responsive?:boolean;legend?:{display:boolean;}};
...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    let config:RespChartConfiguration = {
      type: 'line',
      data: {
        labels: chart_labels,
        datasets: [{
    ...
    const barConfig:RespChartConfiguration = {
      type: 'bar',
      responsive: true,
      legend: {
        display: false
    ...
    let myChart2 = new Chart(this.ctx,barConfig);
