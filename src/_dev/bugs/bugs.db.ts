...
export const INITIAL_BUGS:Bug[] = [
  {
    id:"626f009c-befe-1836-b57e-6fb204300d5f",
    uid:"hv6nr3vhu",
    status:"in-progress",
    ...
    id:"626f009c-befe-1836-b57e-6fb204300dd9",
    uid:"mv6nr3x4s",
    status:"new",
    title:"Refactor spending module",
    description:"Something important to take it over the top",
    createdOn:new Date(),
    lastUpdated:new Date(),
    dueDate:new Date("1/27/25"),
    type:"front-end",
    progress:45,
    tasks:[
      {
